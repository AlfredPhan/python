#Program No. 7 Searching the code string in the .py file
import os
def read(filename):
...
def index_and_search(dirname, root_path_length, search_string):
    ...
    for filename in filenames:
        ...
        if os.path.isdir(path):
            ...
            if occurrences > 0:
                print(f"{occurrences:4} {path[root_path_length:]}")
try:
    while True:
...
except OSError as err: #Exception handling built in fucntion
    print(err)
