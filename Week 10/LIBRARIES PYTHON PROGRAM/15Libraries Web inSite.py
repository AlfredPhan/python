#Webinsite -> Embedding the web search engiene in python platform

from tkinter import *
from tkinter import messagebox
from tkinter import scrolledtext
from tkinter.ttk import * #theme tkinter
...
def load_url_text(event):
    ...
    if not url.startswith("http"):
        ...
        url_output.set(url)#hyper text transfer protocol secure
    load_webpage_text(url)
